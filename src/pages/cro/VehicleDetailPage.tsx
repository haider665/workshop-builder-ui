        ...
        <Dialog open={Boolean(editDraft)} onClose={() => !saving && setEditDraft(null)} fullWidth maxWidth="md">
          ...
          <DialogContent dividers>
            {editDraft ? <Stack spacing={2} sx={{ pt: 1 }}>
              ...
              <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}><TextField type="number" label="Model year" value={editDraft.modelYear ?? ''} onChange={(e) => setEditDraft({ ...editDraft, modelYear: e.target.value ? Number(e.target.value) : undefined })} fullWidth /><TextField label="Country of origin" value={editDraft.countryOfOrigin ?? ''} onChange={(e) => setEditDraft({ ...editDraft, countryOfOrigin: e.target.value })} fullWidth /><TextField label="Country of assembly" value={editDraft.countryOfAssembly ?? ''} onChange={(e) => setEditDraft({ ...editDraft, countryOfAssembly: e.target.value })} fullWidth /></Stack>
              ...
              <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}><TextField label="Exterior colour code" value={editDraft.exteriorColorCode ?? ''} onChange={(e) => setEditDraft({ ...editDraft, exteriorColorCode: e.target.value })} fullWidth /><TextField label="Interior colour code" value={editDraft.interiorColorCode ?? ''} onChange={(e) => setEditDraft({ ...editDraft, interiorColorCode: e.target.value })} fullWidth /><TextField select label="Status" value={editDraft.status} onChange={(e) => setEditDraft({ ...editDraft, status: e.target.value as CWVehicle['status'] })} fullWidth><MenuItem value="Active">Active</MenuItem><MenuItem value="Inactive">Inactive</MenuItem></TextField></Stack>
