      ...
      <Stack spacing={3}>
        ...
        <Dialog open={Boolean(editDraft)} onClose={() => !saving && setEditDraft(null)} fullWidth maxWidth="md">
          ...
          <DialogContent dividers>{editDraft ? <Stack spacing={2} sx={{ pt: 1 }}>
            ...
            <Typography sx={{ fontWeight: 800, color: colors.slate[700], mt: 1 }}>Address and occupation</Typography>
            <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}><TextField label="Division" value={editDraft.address?.division ?? ''} onChange={(e) => setEditDraft({ ...editDraft, address: { ...(editDraft.address ?? {}), division: e.target.value } })} fullWidth /><TextField label="City" value={editDraft.address?.city ?? ''} onChange={(e) => setEditDraft({ ...editDraft, address: { ...(editDraft.address ?? {}), city: e.target.value } })} fullWidth /><TextField label="Postal code" value={editDraft.address?.postalCode ?? ''} onChange={(e) => setEditDraft({ ...editDraft, address: { ...(editDraft.address ?? {}), postalCode: e.target.value } })} fullWidth /></Stack>
            <TextField label="Street address" value={editDraft.address?.street ?? ''} onChange={(e) => setEditDraft({ ...editDraft, address: { ...(editDraft.address ?? {}), street: e.target.value } })} fullWidth multiline minRows={2} />
            <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}><TextField label="Occupation type" value={editDraft.occupation?.type ?? ''} onChange={(e) => setEditDraft({ ...editDraft, occupation: { ...(editDraft.occupation ?? {}), type: e.target.value } })} fullWidth /><TextField label="Employer / company" value={editDraft.occupation?.companyName ?? ''} onChange={(e) => setEditDraft({ ...editDraft, occupation: { ...(editDraft.occupation ?? {}), companyName: e.target.value } })} fullWidth /><TextField label="Designation" value={editDraft.occupation?.designation ?? ''} onChange={(e) => setEditDraft({ ...editDraft, occupation: { ...(editDraft.occupation ?? {}), designation: e.target.value } })} fullWidth /></Stack>
            <Typography sx={{ fontWeight: 800, color: colors.slate[700], mt: 1 }}>Corporate and contact links</Typography>
            <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}><TextField label="Parent company" value={editDraft.corporate?.parentCompanyName ?? ''} onChange={(e) => setEditDraft({ ...editDraft, corporate: { ...(editDraft.corporate ?? {}), parentCompanyName: e.target.value } })} fullWidth /><TextField label="Transport officer" value={editDraft.corporate?.transportOfficerName ?? ''} onChange={(e) => setEditDraft({ ...editDraft, corporate: { ...(editDraft.corporate ?? {}), transportOfficerName: e.target.value } })} fullWidth /><TextField label="Transport officer phone" value={editDraft.corporate?.transportOfficerPhone ?? ''} onChange={(e) => setEditDraft({ ...editDraft, corporate: { ...(editDraft.corporate ?? {}), transportOfficerPhone: e.target.value } })} fullWidth /></Stack>
            <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}><TextField label="WhatsApp link" value={editDraft.whatsappLink ?? ''} onChange={(e) => setEditDraft({ ...editDraft, whatsappLink: e.target.value })} fullWidth /><TextField label="Facebook link" value={editDraft.facebookLink ?? ''} onChange={(e) => setEditDraft({ ...editDraft, facebookLink: e.target.value })} fullWidth /><TextField label="LinkedIn link" value={editDraft.linkedinLink ?? ''} onChange={(e) => setEditDraft({ ...editDraft, linkedinLink: e.target.value })} fullWidth /><TextField label="Google link" value={editDraft.googleLink ?? ''} onChange={(e) => setEditDraft({ ...editDraft, googleLink: e.target.value })} fullWidth /></Stack>
            <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}><TextField label="Parent company division" value={editDraft.corporate?.parentCompanyAddress?.division ?? ''} onChange={(e) => setEditDraft({ ...editDraft, corporate: { ...(editDraft.corporate ?? {}), parentCompanyAddress: { ...(editDraft.corporate?.parentCompanyAddress ?? {}), division: e.target.value } } })} fullWidth /><TextField label="Parent company city" value={editDraft.corporate?.parentCompanyAddress?.city ?? ''} onChange={(e) => setEditDraft({ ...editDraft, corporate: { ...(editDraft.corporate ?? {}), parentCompanyAddress: { ...(editDraft.corporate?.parentCompanyAddress ?? {}), city: e.target.value } } })} fullWidth /><TextField label="Parent company postal code" value={editDraft.corporate?.parentCompanyAddress?.postalCode ?? ''} onChange={(e) => setEditDraft({ ...editDraft, corporate: { ...(editDraft.corporate ?? {}), parentCompanyAddress: { ...(editDraft.corporate?.parentCompanyAddress ?? {}), postalCode: e.target.value } } })} fullWidth /></Stack>
            <TextField label="Parent company street" value={editDraft.corporate?.parentCompanyAddress?.street ?? ''} onChange={(e) => setEditDraft({ ...editDraft, corporate: { ...(editDraft.corporate ?? {}), parentCompanyAddress: { ...(editDraft.corporate?.parentCompanyAddress ?? {}), street: e.target.value } } })} fullWidth />
            <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}><TextField label="Officer email" type="email" value={editDraft.corporate?.transportOfficerEmail ?? ''} onChange={(e) => setEditDraft({ ...editDraft, corporate: { ...(editDraft.corporate ?? {}), transportOfficerEmail: e.target.value } })} fullWidth /><TextField label="Transport manager" value={editDraft.corporate?.transportManagerName ?? ''} onChange={(e) => setEditDraft({ ...editDraft, corporate: { ...(editDraft.corporate ?? {}), transportManagerName: e.target.value } })} fullWidth /><TextField label="Manager phone" value={editDraft.corporate?.transportManagerPhone ?? ''} onChange={(e) => setEditDraft({ ...editDraft, corporate: { ...(editDraft.corporate ?? {}), transportManagerPhone: e.target.value } })} fullWidth /></Stack>
            <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}><TextField label="Manager email" type="email" value={editDraft.corporate?.transportManagerEmail ?? ''} onChange={(e) => setEditDraft({ ...editDraft, corporate: { ...(editDraft.corporate ?? {}), transportManagerEmail: e.target.value } })} fullWidth /><TextField label="Corporate note" value={editDraft.corporate?.note ?? ''} onChange={(e) => setEditDraft({ ...editDraft, corporate: { ...(editDraft.corporate ?? {}), note: e.target.value } })} fullWidth multiline minRows={2} /><TextField label="Corporate social media" value={editDraft.corporate?.socialMedia ?? ''} onChange={(e) => setEditDraft({ ...editDraft, corporate: { ...(editDraft.corporate ?? {}), socialMedia: e.target.value } })} fullWidth /></Stack>
            <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}><TextField select label="Self driven" value={editDraft.isSelfDriven ? 'Yes' : 'No'} onChange={(e) => setEditDraft({ ...editDraft, isSelfDriven: e.target.value === 'Yes' })} fullWidth><MenuItem value="Yes">Yes</MenuItem><MenuItem value="No">No</MenuItem></TextField><TextField select label="Personal use" value={editDraft.isPersonalUse ? 'Yes' : 'No'} onChange={(e) => setEditDraft({ ...editDraft, isPersonalUse: e.target.value === 'Yes' })} fullWidth><MenuItem value="Yes">Yes</MenuItem><MenuItem value="No">No</MenuItem></TextField><TextField select label="Status" value={editDraft.status ?? 'Active'} onChange={(e) => setEditDraft({ ...editDraft, status: e.target.value as CWCustomer['status'] })} fullWidth><MenuItem value="Active">Active</MenuItem><MenuItem value="Inactive">Inactive</MenuItem></TextField></Stack>
