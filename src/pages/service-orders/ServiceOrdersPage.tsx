...
type ServiceOrder = { id: string; companyId: string; shopId: string; appointmentId: string; customerId: string; vehicleId: string; status: string; currency: string; promisedCompletionAt?: string; subtotal: number; discountAmount: number; taxAmount: number; grandTotal: number; lines: OrderLine[]; updatedAt: string }
